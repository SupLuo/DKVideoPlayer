...
open class UCSVideoView @JvmOverloads constructor(
    ...
    //播放器
    private val mPlayer: UCSPlayerProxy = UCSPlayerProxy(context),
    private val mDisplayContainer: UCSDisplayContainer = UCSDisplayContainer(context)
     ...
     * 真正的播放器内核
     */
    protected val kernel: UCSPlayer? get() = mPlayer.kernel
