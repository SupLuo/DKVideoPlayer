...
public class ParallelPlayActivity extends AppCompatActivity {
    ...
    private List<UNSVideoView> mVideoViews = new ArrayList<>();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        UNSVideoView player1 = findViewById(R.id.player_1);
        ...
        UNSVideoView player2 = findViewById(R.id.player_2);
    ...
    protected void onPause() {
        super.onPause();
        for (UNSVideoView vv : mVideoViews) {
            vv.pause();
        }
    }
