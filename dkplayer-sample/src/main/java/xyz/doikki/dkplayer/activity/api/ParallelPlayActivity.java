...
public class ParallelPlayActivity extends AppCompatActivity {
    ...
    private List<UCSVideoView> mVideoViews = new ArrayList<>();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        UCSVideoView player1 = findViewById(R.id.player_1);
        ...
        UCSVideoView player2 = findViewById(R.id.player_2);
    ...
    protected void onPause() {
        super.onPause();
        for (UCSVideoView vv : mVideoViews) {
            vv.pause();
        }
    }
